...
const editPoint = () => (
  ...
  <div class="event__field-group  event__field-group--price">
    ...
    <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${points.base_price}">
  </div>
...
export { editPoint, addNewPointWithoutDestination, addNewPointWithoutOffers, addNewPoint };
